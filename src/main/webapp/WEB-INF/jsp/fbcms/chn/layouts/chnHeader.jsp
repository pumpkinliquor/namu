...
<html lang="zh-Hans">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/css/fbcms/chn/slick.css"><!-- slider -->
		<link rel="stylesheet" type="text/css" href="/css/fbcms/chn/common.css">
		<link rel="icon" type="image/png"  href="/images/favicon.png"/>
		<script type="text/javascript" src="/js/fbcms/chn/jquery.js"></script>
		<script type="text/javascript" src="/js/fbcms/chn/slick.js"></script><!-- slider -->
		<script type="text/javascript" src="/js/fbcms/chn/common.js"></script>
		<script>
