...
<div class="contents w1200">
	...
	<ul class="tab_list"><!-- tab -->
		...
		<li>
			<a href="javascript:void(0);">대상자/추가검사패키지</a></li>
	</ul>

	<div class="tab_box"><!-- box01 -->
		<h4 class="con_in_tit12">나무병원 공단검진센터</h4>
		<img src="/images/fbcms/user/img_exam03_01.png" alt="" class="mb30">
		<video id="myVideo" src="/getImage/resource/%EA%B3%B5%EB%8B%A8%EA%B2%80%EC%A7%84.mp4" width="100%" controls autoplay muted></video>

		<h4 class="con_in_tit12">보건복지부 공단검진 우수등급 획득</h4>
		<p class="con_in_txt02">비에비스 나무병원은 보건복지부 공단검진(국민건강검진) 기관평가에서 공단검진 일반검진분야는 물론 위암검진, 대장암검진, 진단의학분야 등에서 우수등급을 획득했습니다</p>
		<img src="/images/fbcms/user/img_exam03_02.png" alt="" class="img_center">

		<h4 class="con_in_tit12">일반검진은 물론 국가암검진도 시행하며, 추가검사도 가능합니다</h4>
		<div class="exam03_01">
			<div>
				<img src="/images/fbcms/user/img_exam03_03.png" alt="">
				<p>공단검진 일반검진</p>
			</div>
			<div>
				<img src="/images/fbcms/user/img_exam03_04.png" alt="">
				<p>공단검진 암검진</p>
			</div>
		</div>
		<!-- <h5 class="con_in_tit01">NAMUH 추가검사 패키지</h5>
		<div class="exam03_02">
			<div class="ex0301">
				<h6>주요혈액<br>맞춤검사</h6>
				<p>7만원</p>
	...
	<div class="tab_box"><!-- box02 -->
		<h4 class="con_in_tit11">공단검진 대상자</h4>
		<h5 class="con_in_tit02 mt70">일반공단검진</h5>
		...
		<ul class="cancer">
			<li>
				<img src="/images/fbcms/user/img_exam03_05.png" alt="">
				<strong>위암</strong>
				<span>만 40세 이상</span>
			</li>
			<li>
				<img src="/images/fbcms/user/img_exam03_06.png" alt="">
				<strong>대장암</strong>
				<span>만 50세 이상</span>
			</li>
			<li>
				<img src="/images/fbcms/user/img_exam03_07.png" alt="">
				<strong>간암</strong>
				<span>고위험군으로 지정된 분</span>
			</li>
			<li>
				<img src="/images/fbcms/user/img_exam03_08.png" alt="">
				<strong>유방암</strong>
				<span>만 40세 이상</span>
			</li>
			<li>
				<img src="/images/fbcms/user/img_exam03_09.png" alt="">
				<strong>자궁경부암</strong>
				<span>만 20세 이상</span>
			</li>
		</ul>
		...
		<h4 class="con_in_tit11">공단검진 항목</h4>
		<h5 class="con_in_tit02 mt70">일반공단검진</h5>
		<h6 class="con_in_tit01 mt45">공통 검사 항목</h6>
		<p class="con_in_txt02">신장, 체중, 허리둘레, 체질량지수, 청력, 시력, 혈압, 빈혈, 간기능, 당뇨, 신장기능, 흉부촬영, 소변검사</p>
		<h6 class="con_in_tit01 mt45">성&middot;연령별 검사 항목</h6>
		<div class="tbox tdetail03">
			<table>
		...
		<div class="tbox tdetail03">
			<table>
				...
				<tbody>
					<tr>
						<td class="t_left c_gray3">위암검진</td>
						<td class="t_left">위내시경</td>
						<td class="t_left">만 40세 이상 남녀 : 2년마다</td>
					</tr>
					<tr>
						<td class="t_left c_gray3" rowspan="2">대장암검진</td>
						<td class="t_left">분변잠혈검사(FOBT)</td>
						<td class="t_left">만 50세 이상 남녀 : 1년마다</td>
					</tr>
					<tr>
						<td class="t_left">대장내시경검사</td>
						<td class="t_left">분변잠혈검사(FOBT) 양성판정자</td>
					</tr>
					<tr>
						<td class="t_left c_gray3">간암검진</td>
					...
					<tr>
						<td class="t_left c_gray3">유방암검진</td>
						<td class="t_left">유방촬영검사</td>
						<td class="t_left">만 40세 이상 남녀 : 2년마다</td>
					</tr>
					<tr>
						<td class="t_left c_gray3">자궁경부암검진</td>
						<td class="t_left">자궁경부세포검사</td>
						<td class="t_left">만 40세 이상 남녀 : 2년마다</td>
					</tr>
				</tbody>
			</table>
		</div>
		<h4 class="con_in_tit11 mb20">NAMUH 추가검사 패키지</h4>
		<p class="con_in_txt02 mb45">공단검진만으로 불안하다면, 추가검사 패키지를 이용해보세요</p>
		<div class="exam03_02">
			<img src="/images/fbcms/user/img_infoICC_01.jpg" style="width:100%;" alt="추가검사 패키지">
			<!-- <div class="ex0301">
				<h6>주요혈액<br>맞춤검사</h6>
				<p>7만원</p>
				<ul>
