...
<div class="contents w1200">
	...
	<form:form commandName="articleVO" name="formInsert" action="/user/cts/cst/insertCST.do" method="post" onSubmit="insertCST(document.formInsert); return false;" enctype="multipart/form-data">
		...
		<div class="btn_Lbox">
			...
			<a href="#none" onclick="javascript:insertCST(document.formInsert)" class="btn bblue">등록</a>
		</div>
