			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<span>-</span>
						<input type="text" name="mCtn" id="mCtn" class="w120" title="휴대폰 가운데 자리" required="required" maxlength="4" value="${fn:split(appointmentVO.MOBILE_PHONE_NO,'-')[1]}">
						<span>-</span>
						<input type="text" name="lCtn" id="lCtn" class="w120" title="휴대폰 뒷 자리" required="required" maxlength="4" value="${fn:split(appointmentVO.MOBILE_PHONE_NO,'-')[2]}">
					</td>
				</tr>
				<tr>
