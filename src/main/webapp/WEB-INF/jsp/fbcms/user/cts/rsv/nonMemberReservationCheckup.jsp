...
<div class="contents w1200">
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td><input type="text" name="usrNm" id="usrNm" class="w1400" title="이름" value="${appointmentVO.APPO_PRSN_NM}" maxlength="13">
						<input type="hidden" name="usrNmTemp" id="usrNmTemp" class="w1400" title="이름" value="${appointmentVO.APPO_PRSN_NM}" maxlength="13"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<span>-</span>
							<input type="text" name="mCtn" id="mCtn" class="w120" title="휴대폰 가운데 자리" required="required" onkeypress="onlyNumber()" maxlength="4" value="${fn:split(appointmentVO.MOBILE_PHONE_NO,'-')[1]}">
							<span>-</span>
							<input type="text" name="lCtn" id="lCtn" class="w120" title="휴대폰 뒷 자리" required="required" onkeypress="onlyNumber()" maxlength="4" value="${fn:split(appointmentVO.MOBILE_PHONE_NO,'-')[2]}">
						</td>
					</tr>
					<tr>
	...
	<div class="btn_Lbox"><!-- btn box -->
		<a href="javascript:fnGetProcess('/user/cts/rsv/nonMemberReservationCheckupStepInfo.do');" class="btn bgreen">이전</a>
