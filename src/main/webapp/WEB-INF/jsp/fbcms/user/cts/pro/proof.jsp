...
<div class="contents w1200">
	...
	<ul class="tab_list"><!-- tab -->
		<li class="selected"><a href="javascript:void(0);" title="선택된 탭">발급절차</a></li>
		<li><a href="javascript:void(0);">구비서류안내</a></li>
		<li><a href="javascript:void(0);">발급비용</a></li>
	</ul>

	<section class="tab_box" style="display:block"><!-- //tab contents1 s -->
		<div class="box_tit">
			<strong>외래환자</strong>
			<p>&#8251; 신규 진단서 발급은 환자 본인에 한하여 가능합니다</p>
		</div>

		<h4 class="con_in_tit01">제증명 서류</h4>
		<ul class="proof_list">
			<li>
				<span>01</span>
				<p>담당 의사<br>진료일로 접수</p>
				<em>콜센터 및 원무팀</em>
			</li>
			<li>
				<span>02</span>
		...
		<h4 class="con_in_tit01">의무기록 및 영상자료</h4>
		<ul class="proof_list">
			<li>
				<span>01</span>
				<p>담당 의사<br>진료일로 접수</p>
		...
		<ol class="re_step guide01">
			<li class="line2"><p>발급의뢰<br><span>(해당 병동 간호사)</span></p></li>
			<li><p>주치의 작성</p></li>
			<li class="line2"><p>발급<br><span>(원무팀)</span></p></li>
		</ol>
	...
	<section class="tab_box"><!-- //tab contents2 s -->
		...
		<h4 class="con_in_tit02">사본발급 시 필요한 서류</h4>
		<ul class="dot_list">
		...
		<div class="tbox tdetail03 mt50">
			<table>
				...
				<tbody>
					...
					<tr>
						<th scope="row">환자(만19세 미만) 친권자</th>
						<td>
							<ul class="hy_list hyphen02">
								<li>친권자의 신분증</li>
					...
					<tr>
						<th scope="row">친족<span>(배우자, 직계존속, 직계비속,<br>배우자의 직계존속)</span></th>
						<td class="t_left">
							<ul class="hy_list hyphen02">
							...
							<p class="desc01 mt10"><strong class="c_point">* 형제 자매는 <환자의 대리인>기준으로만 발급 가능</strong>(친족 기준에 해당 안됨)</p>
						</td>
					</tr>
					<tr>
						<th scope="row">환자 대리인<span>(형제&middot;자매&middot;보험회사 등)</span></th>
						<td>
							<ul class="hy_list hyphen02">
								<li>신청자의 신분증 또는 사본</li>
								<li>환자가 자필 서명한 동의서</li>
		...
		<h4 class="con_in_tit02 mt100">양식 다운로드</h4>
			<ul class="proof_down">
				<li>
		...
		<h4 class="con_in_tit02">사본발급 가능시간</h4>
		<ul class="dot_list">
			<li>평　일 <span class="ml15">08:00 ~ 13:00</span><span class="bar">14:00 ~ 16:30</span></li>
			<li>토요일 <span class="ml15">08:00 ~ 12:30</span></li>
		</ul>
		<p class="desc01 c_point">* 각종 진단서 및 의무기록 사본 발급시 반드시 담당의사 진료시간을 확인하시고 오셔야 합니다</p>
	</section><!-- //tab contents2 e -->

	<section class="tab_box"><!-- //tab contents3 s -->
	<h4 class="con_in_tit02">제증명 종류</h4>
	<div class="tbox tdetail03 mt50">
			<table>
				...
				<tbody>
					<tr>
						<th scope="row">진료과 주치의 발급<span>(진료 예약필요)</span></th>
						<td>
							<ul class="hy_list hyphen02">
								<li>진료기록지, 의뢰서</li>
								<li>통원확인서(병명 기재)</li>
		...
		<h4 class="con_in_tit02 mt100">수수료</h4>
		<div class="tbox tdetail03 mt50">
			<table>
				...
				<tbody>
					...
					<tr>
						<th class="t_left" scope="row">진단서/소견서(영문)</th>
						<td>
							<ul>
								<li>20,000</li>
							</ul>
					...
					<tr>
						<th class="t_left" scope="row">입퇴원확인서 및 통원확인서(병명,날짜기재)</th>
						<td>
							<ul>
								<li>3,000</li>
							</ul>
					...
					<tr>
						<th class="t_left" scope="row">통원확인서(날짜만 기재)</th>
						<td>
							<ul>
								<li>무료</li>
							</ul>
					...
					<tr>
						<th class="t_left" scope="row">의무기록사본 (기본5장)</th>
						<td>
							<ul>
								<li>1,000</li>
							</ul>
		...
		<p class="desc01 c_point mt20">* 증명서 발급비용은 진찰료와는 별도로 부담하셔야 합니다.</p>
