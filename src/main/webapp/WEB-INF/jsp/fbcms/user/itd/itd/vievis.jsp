	...
	<section class="vievis_box namuh"><!-- tab contents1 s -->
		...
		<ul class="w1200 namuh_list">
			...
			<li>
				...
				교수역임 전문의들이 진료는 물론, 내시경&middot;초음파 등의<br>
	...
	<section class="vievis_box mission"><!-- tab contents3 s -->
		...
		<section class="mission_box w1200">
			...
			<div>
				...
				<ul>
					...
					<li><!-- 1204 수정 -->
						<strong>혁신 추구</strong>
						메디컬케어 혁신에 리더로 자리매김하며, <br>
						창의적이고 꾸준한 연구와 발전으로 전문적<br>
						이고 차별화된 의료서비스를 제공합니다
					</li>
					<li>
						<strong>사회공헌</strong>
		...
		<section class="mission_box w1200">
			...
			<div class="btn_Lbox"><!-- btn box -->
				<a href="javascript:resourceFileDown('로고_다운파일.png');" class="btn breservation">Download</a>
			</div>
		</section>
