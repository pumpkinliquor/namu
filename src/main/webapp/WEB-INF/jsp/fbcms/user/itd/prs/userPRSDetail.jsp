...
<div class="contents w1200">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="t_date t_right"><span><c:out value="${fn:substring(result.customDate1, 0, 10)}" /></span></td>
				</tr>
				<tr class="t_con">
					<td colspan="3">
						<div>
							<%-- <c:out value="${fn:replace(result.nttCn, crlf , '<br>')}" escapeXml="false" /> --%>
							<%-- <c:set var="changeHtml"><c:out value='${result.nttCn}' escapeXml='false' /></c:set> --%>
	...
	<div class="btn_Lbox">
		<a href="#none" onclick="javascript:fnPRSList();" class="btn bgray"> 목록으로</a>
	</div>
