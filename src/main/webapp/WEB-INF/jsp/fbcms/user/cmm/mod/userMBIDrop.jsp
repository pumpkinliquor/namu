...
$(function() {
	...
	<div class="container" id="contents">
		...
		<div class="contents w1200">
			...
			<section class="re_login login02">
				...
				회원탈퇴를 원하시는 경우 아래의 탈퇴사유를 선택해주세요</p>
				...
				<div class="btn_Lbox"><!-- btn box -->
					<a href="javascript:void(0);" class="btn bgreen popup">회원탈퇴</a>
					<a href="javascript:void(0);" class="btn bblue">취소</a>
				</div>
			</section>
	...
	<div class="layer w450">
		<h5 class="layer_tit">회원탈퇴 완료</h5>
		<p class="layer_txt">그동안 나무병원 홈페이지를 이용해주셔서 감사합니다</p>
		<div class="btn_Lbox"><!-- btn box -->
