		...
		<form action="javascript:void(0);" method="post" id="signupform">
			<section class="re_login joinbox">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="text" class="w510" title="아이디" maxlength="40" id="userId" name="USER_ID" placeholder="아이디를 입력해주세요">
						...
						<tr>
							...
							<td>
								<input type="password" class="w510" title="비밀번호" maxlength="16" id="password" name="PW_NM" placeholder="비밀번호를 입력해주세요">
						...
						<tr>
							...
							<td>
								<input type="password" class="w510" title="비밀번호 확인" id="passwordconfirm" maxlength="16" placeholder="비밀번호를 입력해주세요">
						...
						<tr>
							...
							<td>
								<input type="text" class="w245" title="이메일 입력" id="emailDetail">
								<span>@</span>
								<input type="text" class="w245" title="이메일 입력" id="emailDomain">
						...
						<tr>
							...
							<td>
								...
								<div>
									<input type="text" name="detailAddress" id="addressDetail" class="w510 disabled mt10" title="상세 주소입력" placeholder="상세주소를 입력해주세요">
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="checkbox" id="reception" name="EMAIL_RECV_YN" value="N">
								<label for="reception">수신</label>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<div class="btn_Lbox"><!-- btn box -->
					<a href="#none" class="btn bgreen" id="prevPage">이전</a>
					<a href="#none" class="btn bblue" id="nextPage">다음</a>
				</div>
			</section>
		</form>
		</div>
