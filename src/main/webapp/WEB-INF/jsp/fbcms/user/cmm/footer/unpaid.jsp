...
<!-- container -->
	<div class="container" id="contents">
		...
		<!-- contents s -->
		<div class="contents terms w1200">
			<h4 class="con_in_tit02">비급여진료비 안내</h4>
			<div class="tbox tdetail03">
				<table>
					...
					<tbody>
                        ...
                        <tr>
							<th scope="row" rowspan="16">초음파검사료</th>
			...
			<p class="desc01 c_point mt20">* “의료기관의 제증명수수료 항목 및 금액에 관한 기준” 고시 발표에 따라 제증명서 발급을 위한 진찰료는 별도 산정됩니다. (2017년 9월 21일부터 시행) </p>
