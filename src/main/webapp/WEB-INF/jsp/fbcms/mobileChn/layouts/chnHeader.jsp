...
<html lang="zh-Hans">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/css/fbcms/mobileChn/slick.css"><!-- slider -->
		<link rel="stylesheet" type="text/css" href="/css/fbcms/mobileChn/common.css">
		<link rel="icon" type="image/png"  href="/images/favicon.png"/>
		<script type="text/javascript" src="/js/fbcms/mobileChn/jquery.js"></script>
		<script type="text/javascript" src="/js/fbcms/mobileChn/slick.js"></script><!-- slider -->
		<script type="text/javascript" src="/js/fbcms/mobileChn/common.js"></script>
		<script>
