...
<link href="/css/danal/style.css" type="text/css" rel="stylesheet" media="all"/>
<title>다날 본인인증</title>
</head>
<%
...
%>
<body>
<form name="CPCGI" action="/danal/Success.do" method="post">

	<%= MakeFormInputHTTP(request.getParameterMap(),"TID") %>
	<%= MakeFormInputHTTP(request.getParameterMap(),"NAME") %>
	<%= MakeFormInputHTTP(request.getParameterMap(),"IDEN") %>
	<%= MakeFormInputHTTP(request.getParameterMap(),"PHONE") %>
