...
<div class="contents">
	<section class="re_login joinbox">
		<h4 class="con_in_tit02 t_center mt40 mb0">입사지원내역</h4>
		<p class="login_top_txt mt20">입사지원자 본인 이름과 설정한 비밀번호를<br>
		입력해주세요</p>
		
		<form name="articleForm" method="post" onSubmit="fnJACUpdate(); return false;">
			<div class="re_loginbox mt40 mar20">
			...
			<div class="btn_Lbox"><!-- btn box -->
				<a href="<c:url value='/user/itd/epm/employmentGuide.do'/>" class="btn bgreen in_full">메인</a>
				<a href="#none" onclick="javascript:fnJACUpdate()" class="btn bblue in_full">입사지원내역 조회&middot;수정</a>
			</div>
		</form>
	</section>
