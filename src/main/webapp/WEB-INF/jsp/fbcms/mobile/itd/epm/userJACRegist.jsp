...
<!-- contents s -->
<div class="contents">
	<h4 class="con_in_tit02 t_center mt40">입사  지원하기</h4>
	<p class="n_txt mar20"><em class="ootc">*</em>필수입력 항목</p>
	
	<form:form commandName="articleVO" name="formInsert" action="/user/itd/epm/insertJAC.do" method="post" onSubmit="insertJAC(document.formInsert); return false;" enctype="multipart/form-data">
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td>
							<input type="text" id="ntcrNm" name="ntcrNm" class="in_full" title="이름" maxlength="20" placeholder="이름을 입력해주세요" value="" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="input_wrap">
								<input type="text" id="customDateCheckl1" name="customDateCheckl1" class="in_full" maxlength="8" placeholder="YYYYMMDD" value="" oninput="this.value = this.value.replace(/[^0-9.]/g, '');"/>
					...
					<tr>
						...
						<td class="phone">
							<select id="custom1" name="custom1" title="휴대전화 앞자리">
							...
							<span>-</span>
							<input type="text" id="custom2" name="custom2" title="휴대전화 가운데 자리" maxlength="4" />
							<span>-</span>
							<input type="text" id="custom3" name="custom3" title="휴대전화 뒷 자리" maxlength="4" />
						</td>
					</tr>
					<tr>
						<th scope="row"><em class="ootc">*</em>이메일</th>
						<td class="phone">
							<input type="text" id="custom4_1" name="custom4_1" title="이메일 입력" maxlength="100" value="" />
							<span>@</span>
							<input type="text" id="custom4_2" name="custom4_2" style="width:calc((100% - -8px) / 3)" title="이메일 입력" maxlength="100" value="" />
							<select title="메일선택" class="ml5 fsize" id="emailSelect" name="emailSelect">
								<option>직접입력</option>
					...
					<tr>
						...
						<td>
							<input type="password" id="password" name="password" class="in_full" title="비밀번호" maxlength="16" placeholder="비밀번호를 입력해주세요" value="" />
					...
					<tr>
						...
						<td>
							<input type="password" id="password_confirm" name="password_confirm" class="in_full" title="비밀번호 확인" maxlength="16" placeholder="비밀번호를 입력해주세요" value="" />
					...
					<tr>
						...
						<td>
							...
							<input type="text" id="b_file_txt" class="in_full" title="입사지원서 업로드" maxlength="40" placeholder="파일을 선택하세요" value="" disabled="disabled" style="width:calc(100% - 108px)">
					...
					<tr>
						<td colspan="2">
							<section class="re_privacy mt30">
								<p>
									<input type="checkbox" id="agree02">
									<label for="agree02">개인정보 수집 및 활용동의(필수)</label>
								</p>
								<div class="s01">
									<h6>개인정보의 수집&middot;이용 목적</h6>
		...
		<div class="btn_Lbox">
			<a href="<c:url value='/user/itd/epm/employmentGuide.do' />" class="btn btn02 bgreen">취소</a>
			<a href="#none" onclick="javascript:insertJAC(document.formInsert)" class="btn btn02 bblue">지원하기</a>
		</div>
