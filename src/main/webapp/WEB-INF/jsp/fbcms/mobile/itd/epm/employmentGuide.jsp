...
<!-- contents s -->
<div class="contents">
	<section class="t_center mar20 mt40">
		<h4 class="con_in_tit08">인재상</h4>
		<img src="/images/fbcms/mobile//img_recruiting01_01.png" alt="VIEVIS NAMUH 인재상:지혜와 사랑으로 고객의 건강을 위해	최선을 다하는 인재, 고객의 니즈 이상으로 최고의 서비스를 실현하는 열정적이고 책임감 있는 인재">
	</section>

	<section class="recruit_gary">
		<h4 class="con_in_tit08">상시 채용절차</h4>
		<img src="/images/fbcms/mobile//img_recruiting01_02.png" alt="1.지원서 다운받기 2.지원서 접수 3.서류전형 4.면접전형 5.채용검진 6.채용">
		<p>
			<strong>지원방법</strong><br>
			입사지원서를 작성하여 <span class="c_gray3 fw_500">‘채용공고’</span>에 지원하시거나,<br> 채용담당자 메일(<a href="mailto:recruit@namu.com" class="c_point">recruit@namu.com</a>)로<br> 이력서를 송부해 주십시오.
		</p>
