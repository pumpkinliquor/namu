...
<div class="contents">
	<div class="tab swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-free-mode">
		<ul class="tab_list swiper-wrapper" id="swiper-wrapper-c4a4b26fe9109afc8" aria-live="polite"><!-- tab -->
			<li class="swiper-slide swiper-slide-active"><a href="#none" onclick="funcOri()" title="선택된 탭">센터소개</a></li>
					...
					<div class="max1200">
						...
						<ul>
							<li>
								...
								<strong>${clinicInfo.TMP_LIST[9].DTIL_LIST[0].TEXT_TX}</strong>
								<span>${clinicInfo.TMP_LIST[9].DTIL_LIST[0].TITLE_CT}</span>
							</li>
							<li>
								<img src="<c:url value='/getImage/'/><c:out value='${clinicInfo.TMP_LIST[9].DTIL_LIST[1].IMG_ATCH_NO}'/>">
								<strong>${clinicInfo.TMP_LIST[9].DTIL_LIST[1].TEXT_TX}</strong>
								<span>${clinicInfo.TMP_LIST[9].DTIL_LIST[1].TITLE_CT}</span>
							</li>
							<li>
								<img src="<c:url value='/getImage/'/><c:out value='${clinicInfo.TMP_LIST[9].DTIL_LIST[2].IMG_ATCH_NO}'/>">
								<strong>${clinicInfo.TMP_LIST[9].DTIL_LIST[2].TEXT_TX}</strong>
								<span>${clinicInfo.TMP_LIST[9].DTIL_LIST[2].TITLE_CT}</span>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="clinic_a09">
					<div class="max1200">
						...
						<div>
							...
							<h5><fbcms:editorTextareaContent value="${clinicInfo.TMP_LIST[10].DTIL_LIST[0].TEXT_TX}" flag="2" /></h5>
						</div>
						<div>
							<img src="<c:url value='/getImage/'/><c:out value='${clinicInfo.TMP_LIST[10].DTIL_LIST[1].IMG_ATCH_NO}'/>">
							<h5><fbcms:editorTextareaContent value="${clinicInfo.TMP_LIST[10].DTIL_LIST[1].TEXT_TX}" flag="2" /></h5>
						</div>
						<div>
							<img src="<c:url value='/getImage/'/><c:out value='${clinicInfo.TMP_LIST[10].DTIL_LIST[2].IMG_ATCH_NO}'/>">
							<h5><fbcms:editorTextareaContent value="${clinicInfo.TMP_LIST[10].DTIL_LIST[2].TEXT_TX}" flag="2" /></h5>
						</div>
						<div>
							<img src="<c:url value='/getImage/'/><c:out value='${clinicInfo.TMP_LIST[10].DTIL_LIST[3].IMG_ATCH_NO}'/>">
							<h5><fbcms:editorTextareaContent value="${clinicInfo.TMP_LIST[10].DTIL_LIST[3].TEXT_TX}" flag="2" /></h5>
						</div>
						<div>
							<img src="<c:url value='/getImage/'/><c:out value='${clinicInfo.TMP_LIST[10].DTIL_LIST[4].IMG_ATCH_NO}'/>">
							<h5><fbcms:editorTextareaContent value="${clinicInfo.TMP_LIST[10].DTIL_LIST[4].TEXT_TX}" flag="2" /></h5>
						</div>
						<div>
							<img src="<c:url value='/getImage/'/><c:out value='${clinicInfo.TMP_LIST[10].DTIL_LIST[5].IMG_ATCH_NO}'/>">
							<h5><fbcms:editorTextareaContent value="${clinicInfo.TMP_LIST[10].DTIL_LIST[5].TEXT_TX}" flag="2" /></h5>
						</div>
					</div>
				</div>
			</c:if>
