				...
				<div class="clinic_b03">
					<div class="max1200">
						...
						<div>
							...
							</div><img src="<c:url value='/getImage/'/><c:out value='${clinicInfo.TMP_LIST[2].DTIL_LIST[0].IMG_ATCH_NO}'/>">
						</div>
...
$(function() {
	...
	//03 이미지 순서 변경
	$('.clinic_b03 > div > p').appendTo($('.clinic_b03 > div > div:nth-of-type(2)'));

   //03 vs top 1210 >> 1221 제거
   //$('.clinic_b03 > div > p').css('top',$('.clinic_b03 h4').height() + $('.clinic_b03 > div > div').eq(0).height() + 55 - 30);
