...
<script src="https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td><input type="text" name="usrNm" id="usrNm" class="disabled in_full" title="이름" value="${userInfo.name}">
						<input type="hidden" name="usrNmTemp" id="usrNmTemp" class="disabled in_full" title="이름" value="${userInfo.name}" maxlength="13"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="phone">
							...
							<span>-</span>
							<input type="text" name="mCtn" id="mCtn" title="휴대폰 가운데 자리" required="required" maxlength="4">
							<span>-</span>
							<input type="text" name="lCtn" id="lCtn" title="휴대폰 뒷 자리" required="required" maxlength="4">
						</td>
					</tr>
					<tr>
	...
	<div class="btn_Lbox"><!-- btn box -->
		<a href="/user/cts/rsv/userRSVCheckupStepInfo.do" class="btn btn02 bgreen">이전</a>
