...
<div class="contents">
	...
	<form:form commandName="articleVO" name="formInsert" action="/user/cts/cst/insertCST.do" method="post" onSubmit="insertCST(document.formsInsert); return false;" enctype="multipart/form-data">
		...
		<div class="btn_Lbox">
			<a href="#none" onclick="javascript:selectCSTList(document.formList)" class="btn btn02 bgreen">취소</a>
			<a href="#none" onclick="javascript:insertCST(document.formInsert)" class="btn btn02 bblue">등록</a>
		</div>
