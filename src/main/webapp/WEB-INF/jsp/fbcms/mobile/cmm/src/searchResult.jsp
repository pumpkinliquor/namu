	...
	<div class="search_de">
		...
		<div class="contents w1200">
			...
			<ul class="tab_list swiper-wrapper"><!-- tab -->
				<li class="swiper-slide" id="liTapAll"><a href="javascript:fnTapAll();" id="fnTapAll">전체<span id="cntAll">(0)</span></a></li>
				<li class="swiper-slide" id="liTap1"><a href="javascript:fnTap1();" id="fnTap1">진료과<span>(${fn:length(resData.sbmList)})</span></a></li>
				<li class="swiper-slide" id="liTap2"><a href="javascript:fnTap2();" id="fnTap2">특화센터<span>(${listCnt})</span></a></li>
				<li class="swiper-slide" id="liTap3"><a href="javascript:fnTap3();" id="fnTap3">의료진<span>(${fn:length(resData.doctorList)})</span></a></li>
				<li class="swiper-slide" id="liTap4"><a href="javascript:fnTap4();" id="fnTap4">건강정보<span>(${bssListTotCnt})</span></a></li>
				<li class="swiper-slide" id="liTap5"><a href="javascript:fnTap5();" id="fnTap5">자주하는 질문<span>(${fn:length(resData.faqList)})</span></a></li>
			</ul>
			</div>
			<div class="all_wrap">
				<h4 class="con_in_tit01 mar20">진료과</h4><!-- 진료과 -->
				<div class="se_box">
				...
				<h4 class="con_in_tit01 mar20">특화센터</h4><!-- 특화센터 -->
				<div class="se_box">
				...
				<h4 class="con_in_tit01 mar20">의료진</h4><!-- 의료진 -->
				<div class="se_box">
					...
					<div class="staff_list">
						...
						<c:if test="${status.count lt 5}">
							<div>
								<img id="drImg" src="<c:url value='/getImage/${DR.pcImgAtchNo}'/>" alt="${DR.drNm}">
								<p>
				...
				<h4 class="con_in_tit01 mar20">건강정보</h4><!-- 건강정보 -->
				<div class="se_box">
				...
				<h4 class="con_in_tit01 mar20">자주하는 질문</h4><!-- 자주하는 질문 -->
				<div class="se_box">
			...
			<div class="health_wrap">
				...
				<div class="se_box">
					...
					<c:forEach items="${resData.boardList}" var="resultInfo" varStatus="status">
						<li>
							<a href="#none" onclick="javascript:selectDSIDetail('<c:out value="${resultInfo.nttId}"/>', '<c:out value="${resultInfo.bbsId}"/>')">
								<strong>${resultInfo.bbsNm}</strong>
								<span class="c_blue"><c:out value='${fn:substring(resultInfo.nttSj, 0, 100)}'/></span>
							</a>
						</li>
					</c:forEach>
					</ul>
...
$(function() {
	...
	$('.btn_faq_more').click(function(e){
		e.preventDefault();
		$('.faq_list dt:hidden').slice(0, 10).show();
		if($('.faq_list dt:hidden').length == 0){
			$('.btn_faq_more').hide();
		}
	});
});
