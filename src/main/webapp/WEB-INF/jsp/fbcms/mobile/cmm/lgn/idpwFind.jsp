...
<div id="container">
	<div class="no_con02">
		...
		<section class="tab_box"><!-- tab contents1 s -->
			<!-- 아이디 찾기 -->
			<div class="re_loginbox" id="find_id">
				<p><label for="name">이름</label>
					<input type="text" id="name" placeholder="이름을 입력해주세요">
				</p>
				<p class="phone"><label for="phfirst">휴대폰</label>
					<select title="휴대폰 앞자리" id="phfirst">
						<option>010</option>
						<option>011</option>
						<option>016</option>
						<option>017</option>
					...
					<span>-</span>
					<input type="text" title="휴대폰 중간자리" id="phmid" maxlength="4" onkeypress="onlyNumber()">
					<span>-</span>
					<input type="text" title="휴대폰 뒷자리" id="phlast" maxlength="4" onkeypress="onlyNumber()">
				</p>
			</div>
			...
			<div id="found_id" style="display: none">
				...
				<div class="btn_Lbox">
					<a href="javascript:void(0);" class="btn btn02 bgreen" id="findPw">비밀번호 찾기</a>
		...
		<section class="tab_box"><!-- tab contents2 s -->
			<!-- 비밀번호 찾기 -->
			<div id="find_pw" class="re_loginbox">
				<p><label for="reid">아이디</label>
			...
			<div id="inputInfo" style="display: none">
				<div class="re_loginbox">
					...
					<p class="phone"><label for="rephfirst">휴대폰</label>
