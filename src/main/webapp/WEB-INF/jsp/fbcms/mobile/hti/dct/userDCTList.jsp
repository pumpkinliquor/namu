...
<div class="contents">
	...
	<ul class="dr_list">
			...
			<c:if test="${status.count lt 5}">
				...
				<li class="dr<c:out value='${classNo}'/>">
					...
					<div class="dr_txt">
						...
						<!-- <a href="javascript:void(0);" class="brview">바로보기</a> -->
		...
		<li class="dr01">
			<img src="/images/fbcms/mobile/etc/bg_dr00_1.jpg" alt="위식도편"/>
			<div class="dr_txt">
				<p>위식도편</p>
		...
		<li class="dr02">
			<img src="/images/fbcms/mobile/etc/bg_dr00_2.jpg" alt="대장항문편"/>
			<div class="dr_txt">
				<p>대장항문편</p>
		...
		<li class="dr03">
			<img src="/images/fbcms/mobile/etc/bg_dr00_3.jpg" alt="간담낭편"/>
			<div class="dr_txt">
				<p>간담낭편</p>
		...
		<li class="dr04">
			<img src="/images/fbcms/mobile/etc/bg_dr00_4.png" alt="무엇이든 물어보세요"/>
			<div class="dr_txt">
				<p>무엇이든 물어보세요</p>
