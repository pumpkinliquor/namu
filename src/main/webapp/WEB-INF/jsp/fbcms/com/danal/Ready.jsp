...
<%
	...
	final String protocol_request = request.isSecure() ? "https://" : "http://";
	final String NAMU_URL = protocol_request+Globals.DOMAIN+"";
...
<%
	...
	TransR.put( "TARGETURL", NAMU_URL + "/danal/CPCGI.do" );
	...
	ByPassValue.put( "BackURL", NAMU_URL + "/danal/BackURL.do" );
