...
<form:form commandName="articleVO" name="formInsert" action="/admin/epm/epa/insertEPA.do" method="post" onSubmit="insertEPA(document.formInsert); return false;" enctype="multipart/form-data"> 
	<div class="board_ty">
		<table>
			<colgroup>
			...
			<tbody>
				<tr>
					<th scope="row" class="ta_r"><em class="ootc">*</em>경력</th>
					<td class="ta_l">
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input name="custom2" title="직군" class="inp_txt w_full" maxlength="100" />
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_l">
						<div class="tab_date_wrap">
							<div class="input_wrap">
								<input type="text" id="customDate1" name="customDate1" class="inp_txt wd110 date_pick" placeholder="">
								<span> - </span>
								<input type="text" id="customDate2" name="customDate2" class="inp_txt wd110 date_pick" placeholder="">
							</div>
						</div>
					</td>
					<th scope="row" class="ta_r">지원자수</th>
					<td class="ta_l">100</td>
				</tr>
				<tr>
	...
	<div class="btns">
		<a href="#none" onclick="javascript:insertEPA(document.formInsert)" class="btn_ty02">저장하기</a>
