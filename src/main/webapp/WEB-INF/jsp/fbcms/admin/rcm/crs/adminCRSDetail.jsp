...
function fnUpdateAppoStat() {
	...
	document.updateForm.action="<c:url value='/admin/rcm/crs/updateAppoStat.do'/>";
...
function fnUpdateReservation() {
	document.updateForm.action="<c:url value='/admin/rcm/crs/updateCRSView.do'/>";
	document.updateForm.submit();
}

</script>

<h3 class="mid_tit mg_t50">검진예약</h3>
	...
	<table>
		...
		<tbody>
			<tr>
				...
				<td class="ta_l" colspan="3"><c:out value="${reservationInfo.EXMN_PROG_NM}"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="ta_l" colspan="3"><c:out value="${reservationInfo.EMAIL_ID}"/></td>
			</tr>
			<tr>
				<th scope="row" class="ta_r">주소</th>
				<td class="ta_l"><c:out value="${reservationInfo.POST_NO} ${reservationInfo.ADDR_TX}"/></td>
				<th scope="row" class="ta_r">상세주소</th>
				<td class="ta_l"><c:out value="${reservationInfo.ADDR_DTIL_TX}"/></td>
			</tr>
			<tr>
			...
			<tr>
				<th scope="row" class="ta_r">문의 및 전달사항</th>
				<td class="ta_l" colspan="3">
					<textarea title="내용" class="textarea_240" id="F_INQR_SEND_TX"><c:url value="${reservationInfo.INQR_SEND_TX}"/></textarea>
				</td>
			</tr>
		</tbody>
	</table>
...
<div class="btns">
	...
	<a href="/admin/rcm/crs/selectCRSList.do" class="btn_ty"> 목록으로 </a>
</div>
