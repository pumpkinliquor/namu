...
<h3 class="mid_tit mg_t50">관리자메뉴관리 수정</h3>
...
<form:form commandName="menuManageVO" name="formUpdate" action="/admin/sym/mpm/updateMenuManage.do" method="post" onSubmit="updateMenuManage(document.formUpdate); return false;">
	<div class="board_ty">
		<table>
			<colgroup>
	...
	<div class="btns">
		<a href="#none" onclick="javascript:deleteMenuManage(formDelete)" class="btn_ty">삭제하기</a>
		<a href="#none" onclick="javascript:updateMenuManage(formUpdate)" class="btn_ty02">저장하기</a>
		<a href="#none" onclick="javascript:selectMenuManageList(document.formList)" class="btn_ty">취소하기</a>
	</div>
...
<form name="formDelete" action="<c:url value='/admin/sym/mpm/deleteMenuManage.do'/>" method="post">
	<input type="hidden" name="menuNo" value="${menuManageVO.menuNo}" readonly="readonly">
</form>
