...
function fnSelectLinkPage(pageNo) {
	...
	document.progrmManageForm.action = "<c:url value='/admin/sym/prm/selectProgrmListSearch.do'/>";
...
<body>
<form name="progrmManageForm" action ="<c:url value='/admin/sym/prm/selectProgrmListSearch.do'/>" method="post">
