...
function fnSelectLinkPage(pageNo) {
	...
	document.progrmManageForm.action = "<c:url value='/admin/sym/prm/selectProgrmListSearchNew.do'/>";
...
<body>
<form name="progrmManageForm" action ="<c:url value='/admin/sym/prm/selectProgrmListSearchNew.do'/>" method="post">
...
<div class="board" style="width:480px">
	...
	<table class="board_list">
		...
		<tbody>
			<c:forEach var="result" items="${listProgrmManage}" varStatus="status">
			  <tr>
			    <td>
