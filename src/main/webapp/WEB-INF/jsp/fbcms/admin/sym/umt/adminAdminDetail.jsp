...
<!--
	 ...
	 * 수정처리
	 ******************************************************** */
	function updateAdminView(form) {
		form.submit();
	}
-->
</script>

<form:form commandName="adminAdminManageVO" name="formUpdate" action="/admin/sym/umt/updateAdminView.do" method="post" onSubmit="updateAdminView(document.formUpdate); return false;">
	...
	<div class="btns">
		<a href="#none" onclick="javascript:updateAdminView(document.formUpdate)" class="btn_ty02"> 수정하기 </a>
	</div>
