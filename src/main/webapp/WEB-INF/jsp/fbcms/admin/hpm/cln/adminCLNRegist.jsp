			...
			<tr>
				...
				<td class="ta_l">
					<div class="input_wrap">
						<input type="text" maxlength="40" class="inp_txt w_full" id="clinicNm" name="clinicNm" value="">
					</div>
				</td>
				...
				<td class="ta_l">
					<div class="input_wrap">
						<span class="ds_raido">
							<span>
								<input type="radio" id="chk01_1" checked="checked" class="ez-hide" value="Y"><!-- id 변경시 label for 값 같이 변경 -->
								<label for="chk01_1">Y</label>
							</span>
							<span>
								<input type="radio" id="chk01_2" class="ez-hide" value="N"><!-- id 변경시 label for 값 같이 변경 -->
			...
			<tr>
				...
				<td class="ta_l" colspan="3">
					<div class="select_wrap">
						<select class="select" name="TEMPL_CD">
...
<form id="formInsertA" name="formInsertA" action="/admin/hpm/cln/insertCLN.do" method="post" onSubmit="insertCLN(document.formInsertA); return false;" enctype="multipart/form-data">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="40" class="inp_txt w_full" name="TMP_LIST[0].AREA_TITLE_CT" value="">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<textarea style="width:100%;height:100px" maxlength="200" name="TMP_LIST[0].DTIL_LIST[0].TEXT_TX"></textarea>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[0].USE_YN" id="chk101_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk101_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[0].USE_YN" id="chk101_2" class="ez-hide" value="N">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="40" class="inp_txt w_full" name="TMP_LIST[1].AREA_TITLE_CT" value="${clinicInfo.TMP_LIST[1].AREA_TITLE_CT}">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[1].USE_YN" id="chk102_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk102_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[1].USE_YN" id="chk102_2" class="ez-hide" value="N">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="200" class="inp_txt w_full" name="TMP_LIST[2].AREA_TITLE_CT" value="${clinicInfo.TMP_LIST[2].AREA_TITLE_CT}">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[2].USE_YN" id="chk103_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk103_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[2].USE_YN" id="chk103_2" class="ez-hide" value="N">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="200" class="inp_txt w_full" name="TMP_LIST[3].AREA_TITLE_CT" value="${clinicInfo.TMP_LIST[3].AREA_TITLE_CT}">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[3].USE_YN" id="chk104_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk104_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[3].USE_YN" id="chk104_2" class="ez-hide" value="N">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="200" class="inp_txt w_full" name="TMP_LIST[4].AREA_TITLE_CT" value="${clinicInfo.TMP_LIST[4].AREA_TITLE_CT}">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[4].USE_YN" id="chk105_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk105_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[4].USE_YN" id="chk105_2" class="ez-hide" value="N">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="200" class="inp_txt w_full" name="TMP_LIST[5].AREA_TITLE_CT" value="${clinicInfo.TMP_LIST[5].AREA_TITLE_CT}">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[5].USE_YN" id="chk106_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk106_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[5].USE_YN" id="chk106_2" class="ez-hide" value="N">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="200" class="inp_txt w_full" name="TMP_LIST[6].AREA_TITLE_CT" value="${clinicInfo.TMP_LIST[6].AREA_TITLE_CT}">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[6].USE_YN" id="chk107_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk107_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[6].USE_YN" id="chk107_2" class="ez-hide" value="N">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="200" class="inp_txt w_full" name="TMP_LIST[7].AREA_TITLE_CT" value="${clinicInfo.TMP_LIST[7].AREA_TITLE_CT}">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								...
								<a class="file_name" id="ta7_file_txt" href="javascript:fnFileDownload('${clinicInfo.TMP_LIST[7].DTIL_LIST[0].IMG_ATCH_NO}','0')" name="TMP_LIST[7].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[7].DTIL_LIST[0].IMG_FILE_NM}</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[7].USE_YN" id="chk108_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk108_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[7].USE_YN" id="chk108_2" class="ez-hide" value="N">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="200" class="inp_txt w_full" name="TMP_LIST[8].AREA_TITLE_CT" value="${clinicInfo.TMP_LIST[8].AREA_TITLE_CT}">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[8].USE_YN" id="chk109_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk109_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[8].USE_YN" id="chk109_2" class="ez-hide" value="N">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="40" class="inp_txt w_full" name="TMP_LIST[9].AREA_TITLE_CT" value="${clinicInfo.TMP_LIST[9].AREA_TITLE_CT}">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="40" class="inp_txt w_full" name="TMP_LIST[9].DTIL_LIST[0].TEXT_TX" value="${clinicInfo.TMP_LIST[9].DTIL_LIST[0].TEXT_TX }">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="40" class="inp_txt w_full" name="TMP_LIST[9].DTIL_LIST[1].TEXT_TX" value="${clinicInfo.TMP_LIST[9].DTIL_LIST[1].TEXT_TX }">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="40" class="inp_txt w_full" name="TMP_LIST[9].DTIL_LIST[2].TEXT_TX" value="${clinicInfo.TMP_LIST[9].DTIL_LIST[2].TEXT_TX }">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[9].USE_YN" id="chk110_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk110_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[9].USE_YN" id="chk110_2" class="ez-hide" value="N">
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<input type="text" maxlength="40" class="inp_txt w_full" name="TMP_LIST[10].AREA_TITLE_CT" value="${clinicInfo.TMP_LIST[10].AREA_TITLE_CT}">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="TMP_LIST[10].USE_YN" id="chk111_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk111_1">Y</label>
								</span>
								<span>
									<input type="radio" name="TMP_LIST[10].USE_YN" id="chk111_2" class="ez-hide" value="N">
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="RLT_MEDI_USE_YN" id="chk112_1" checked="checked" class="ez-hide" value="Y">
									<label for="chk112_1">Y</label>
								</span>
								<span>
									<input type="radio" name="RLT_MEDI_USE_YN" id="chk112_2" class="ez-hide" value="N">
				...
				<tr>
				 ...
				 <tr>
					 ...
					 <td class="ta_l">
						 <div class="input_wrap">
							 <input type="text" id="tagAInput" title="검색 Tag" class="inp_txt w_full" />
							 <input type="hidden" name="SEARCH_TAGS" value="<c:out value='${clinicInfo.SEARCH_TAGS}'/>" >
							 <ul id="tagListA" class="tagbox">
							 </ul>
						 </div>
					 </td>
				 </tr>
	...
	<div class="btns">
		<a href="javascript:insertCLN(document.formInsertA);" class="btn_ty02"> 저장하기 </a>
	...
	<input type="hidden" name="CLINIC_NM" value="">
	<input type="hidden" name="POST_YN" value="Y"/>
	<input type="hidden" name="TEMPL_CD" value="A"/>
	<input type="hidden" name="MAJOR_DISS_CDS" value="">
	<input type="hidden" name="DR_IDS" value="">
</form>

<form id="formInsertB" name="formInsertB" style="display:none;" action="/admin/hpm/cln/insertCLN.do" method="post" onSubmit="insertCLN(document.formInsertB); return false;" enctype="multipart/form-data">
	<div class="board_ty mg_t30">
		<table>
			<colgroup>
				<col span="1" style="width:5%">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tb0100_file_txt" href="#none" name="TMP_LIST[1].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[1].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tb0101_file_txt" href="#none" name="TMP_LIST[1].DTIL_LIST[1].IMG_FILE_NM">${clinicInfo.TMP_LIST[1].DTIL_LIST[1].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tb0200_file_txt" href="#none" name="TMP_LIST[2].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[2].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tb0201_file_txt" href="#none" name="TMP_LIST[2].DTIL_LIST[1].IMG_FILE_NM">${clinicInfo.TMP_LIST[2].DTIL_LIST[1].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tb0300_file_txt" href="#none" name="TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<input type="hidden" name="TMP_LIST[5].DTIL_LIST[0].IMG_ATCH_NO" value="${clinicInfo.TMP_LIST[5].DTIL_LIST[0].IMG_ATCH_NO}">
								<a class="file_name" id="tb0500_file_txt" href="javascript:fnFileDownload('${clinicInfo.TMP_LIST[5].DTIL_LIST[0].IMG_ATCH_NO}','0')" name="TMP_LIST[5].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[5].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<input type="hidden" name="TMP_LIST[5].DTIL_LIST[1].IMG_ATCH_NO" value="${clinicInfo.TMP_LIST[5].DTIL_LIST[1].IMG_ATCH_NO}">
								<a class="file_name" id="tb0501_file_txt" href="javascript:fnFileDownload('${clinicInfo.TMP_LIST[5].DTIL_LIST[1].IMG_ATCH_NO}','0')" name="TMP_LIST[5].DTIL_LIST[1].IMG_FILE_NM">${clinicInfo.TMP_LIST[5].DTIL_LIST[1].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tb0600_file_txt" href="#none" name="TMP_LIST[6].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[6].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				<tr>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<span class="ds_raido">
								<span>
									<input type="radio" name="RLT_MEDI_USE_YN" id="chk112_b1"<c:if test="${clinicInfo.POST_YN ne 'N'}"> checked="checked"</c:if> class="ez-hide" value="Y">
									<label for="chk112_1">Y</label>
								</span>
								<span>
									<input type="radio" name="RLT_MEDI_USE_YN" id="chk112_b2"<c:if test="${clinicInfo.POST_YN eq 'N'}"> checked="checked"</c:if> class="ez-hide" value="N">
									<label for="chk112_2">N</label>
								</span>
							</span>
						</div>
				...
				<tr>
				 ...
				 <tr>
					 ...
					 <td class="ta_l">
						 <div class="input_wrap">
							 <input type="text" id="tagBInput" title="검색 Tag" class="inp_txt w_full" />
							 <input type="hidden" name="SEARCH_TAGS" value="<c:out value='${clinicInfo.SEARCH_TAGS}'/>" >
							 <ul id="tagListB" class="tagbox">
							 </ul>
						 </div>
					 </td>
				 </tr>
	...
	<div class="btns">
		<a href="javascript:insertCLN(document.formInsertB);" class="btn_ty02"> 저장하기 </a>
		<a href="/admin/hpm/cln/selectCLNList.do" class="btn_ty"> 취소하기 </a>
	</div>
...
<form id="formInsertC" name="formInsertC" style="display:none;" action="/admin/hpm/cln/insertCLN.do" method="post" onSubmit="insertCLN(document.formInsertC); return false;" enctype="multipart/form-data">
	<div class="board_ty mg_t30">
		<table>
			<colgroup>
				<col span="1" style="width:5%">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0100_file_txt" href="#none" name="TMP_LIST[1].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[1].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0200_file_txt" href="#none" name="TMP_LIST[2].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0300_file_txt" href="#none" name="TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0301_file_txt" href="#none" name="TMP_LIST[3].DTIL_LIST[1].IMG_FILE_NM">${clinicInfo.TMP_LIST[3].DTIL_LIST[1].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0400_file_txt" href="#none" name="TMP_LIST[4].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[4].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0500_file_txt" href="#none" name="TMP_LIST[5].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[5].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0501_file_txt" href="#none" name="TMP_LIST[5].DTIL_LIST[1].IMG_FILE_NM">${clinicInfo.TMP_LIST[5].DTIL_LIST[1].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
								<label for="file-inputC_5_1">
									<span class="btn_xs">파일 찾기</span>
								</label>
								<input type="file" id="file-inputC_5_1" class="realFile_btn input_none" name="TMP_LIST[5].DTIL_LIST[1].IMG_FILE" title="첨부파일이미지 찾아보기" onchange="javascript:fnFileSelect('tc0501_file_txt',this.value)">
								<span class="dc">*이미지 사이즈 : 1200*567 | 용량: 10mb  이하 |  jpg, gif, png, jpeg</span>
							</div>
						</div>
					</td>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0502_file_txt" href="#none" name="TMP_LIST[5].DTIL_LIST[2].IMG_FILE_NM">${clinicInfo.TMP_LIST[5].DTIL_LIST[2].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0600_file_txt" href="#none" name="TMP_LIST[6].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[6].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0601_file_txt" href="#none" name="TMP_LIST[6].DTIL_LIST[1].IMG_FILE_NM">${clinicInfo.TMP_LIST[6].DTIL_LIST[1].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
								<label for="file-input_6_1">
									<span class="btn_xs">파일 찾기</span>
								</label>
								<input type="file" id="file-input_6_1" class="realFile_btn input_none" name="TMP_LIST[6].DTIL_LIST[1].IMG_FILE" title="첨부파일이미지 찾아보기" onchange="javascript:fnFileSelect('tc0601_file_txt',this.value)">
								<span class="dc">*이미지 사이즈 : 1200*567 | 용량: 10mb  이하 |  jpg, gif, png, jpeg</span>
							</div>
						</div>
					</td>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0602_file_txt" href="#none" name="TMP_LIST[6].DTIL_LIST[2].IMG_FILE_NM">${clinicInfo.TMP_LIST[6].DTIL_LIST[2].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0603_file_txt" href="#none" name="TMP_LIST[6].DTIL_LIST[3].IMG_FILE_NM">${clinicInfo.TMP_LIST[6].DTIL_LIST[3].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0700_file_txt" href="#none" name="TMP_LIST[7].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[7].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0701_file_txt" href="#none" name="TMP_LIST[7].DTIL_LIST[1].IMG_FILE_NM">${clinicInfo.TMP_LIST[7].DTIL_LIST[1].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0702_file_txt" href="#none" name="TMP_LIST[7].DTIL_LIST[2].IMG_FILE_NM">${clinicInfo.TMP_LIST[7].DTIL_LIST[2].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0703_file_txt" href="#none" name="TMP_LIST[7].DTIL_LIST[3].IMG_FILE_NM">${clinicInfo.TMP_LIST[7].DTIL_LIST[3].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0800_file_txt" href="#none" name="TMP_LIST[8].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[8].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0801_file_txt" href="#none" name="TMP_LIST[8].DTIL_LIST[1].IMG_FILE_NM">${clinicInfo.TMP_LIST[8].DTIL_LIST[1].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0802_file_txt" href="#none" name="TMP_LIST[8].DTIL_LIST[2].IMG_FILE_NM">${clinicInfo.TMP_LIST[8].DTIL_LIST[2].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0803_file_txt" href="#none" name="TMP_LIST[8].DTIL_LIST[3].IMG_FILE_NM">${clinicInfo.TMP_LIST[8].DTIL_LIST[3].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0804_file_txt" href="#none" name="TMP_LIST[8].DTIL_LIST[4].IMG_FILE_NM">${clinicInfo.TMP_LIST[8].DTIL_LIST[4].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc0900_file_txt" href="#none" name="TMP_LIST[9].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[9].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc1000_file_txt" href="#none" name="TMP_LIST[10].DTIL_LIST[0].IMG_FILE_NM">${clinicInfo.TMP_LIST[10].DTIL_LIST[0].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc1001_file_txt" href="#none" name="TMP_LIST[10].DTIL_LIST[1].IMG_FILE_NM">${clinicInfo.TMP_LIST[10].DTIL_LIST[1].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc1002_file_txt" href="#none" name="TMP_LIST[10].DTIL_LIST[2].IMG_FILE_NM">${clinicInfo.TMP_LIST[10].DTIL_LIST[2].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
				...
				<tr>
					...
					<td class="ta_l">
						<div class="add_file_wrap">
							<div>
								<a class="file_name" id="tc1003_file_txt" href="#none" name="TMP_LIST[10].DTIL_LIST[3].IMG_FILE_NM">${clinicInfo.TMP_LIST[10].DTIL_LIST[3].IMG_FILE_NM}</a><a href="#none" class="btn_shape_x">삭제</a>
							</div>
							<div class="input_wrap b_file_area">
			...
			<tbody>
				...
				<tr>
				 ...
				 <tr>
					 ...
					 <td class="ta_l">
						 <div class="input_wrap">
							 <input type="text" id="tagCInput" title="검색 Tag" class="inp_txt w_full" />
							 <input type="hidden" name="SEARCH_TAGS" value="<c:out value='${clinicInfo.SEARCH_TAGS}'/>" >
							 <ul id="tagListC" class="tagbox">
							 </ul>
						 </div>
					 </td>
				 </tr>
	...
	<div class="btns">
		<a href="javascript:insertCLN(document.formInsertC);" class="btn_ty02"> 저장하기 </a>
		<a href="/admin/hpm/cln/selectCLNList.do" class="btn_ty"> 취소하기 </a>
	</div>
	...
	<div class="sm_con" style="top:300px">
		...
		<div class="pop_cont">
			...
			<div class="sear selectDiss">
				<!-- <a class="file_name" href="javascript:void(0);">십이이장염</a><a href="javascript:void(0);" class="btn_shape_x">삭제</a> -->
			</div>
					...
					<tbody>
						<c:forEach var="dissInfo" items="${dissList}" varStatus="status">
							<tr id="dissCode_${dissInfo.CODE_ID}">
								...
								<td><a href="javascript:void(0);" class="btn sm addDiss">추가</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
...
<div class="lypop_wrap" id="lypop02">
	<div class="sm_con" style="top: 300px">
		...
		<div class="pop_cont">
			...
			<div class="sear">
				<input type="text" maxlength="40" class="inp_txt w_full searchDr" style="width:100%">
			...
			<div class="sear selectDr">
				<!-- <a class="file_name" href="javascript:void(0);">송대근</a><a href="javascript:void(0);" class="btn_shape_x">삭제</a> -->
			</div>
					...
					<tbody>
						<c:forEach var="drInfo" items="${drList}" varStatus="status">
							<tr id="drId_${drInfo.drId }">
								...
								<td><a href="javascript:void(0);" class="btn sm addDr">추가</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
...
<!--
	...
	function fnInit() {
		// 템플릿 변경시
		$("select[name=TEMPL_CD]").change(function(e) {
			e.preventDefault();
		...
		/* 검색 태그 */
		$('#tagAInput').on('keypress', function (e) {
			...
			if (e.key === 'Enter' || e.keyCode == 32) { // input 에 focus 되있을 때 엔터 및 스페이스바 입력시 구동
				...
				if (tagValue !== "") { // 값이 없으면 동작 안함
					var result = Object.values(tagNmListA).filter(function (word) { // 같은 태그가 있는지 검사한다. 있다면 해당값이 array 로 return 된다.
						return word === tagValue;
					});
					// 태그 중복 검사
					if (result.length == 0) {
						var tagListACnt = $('#tagListA li').length*1;
						$('#tagListA').append('<li>'+tagValue+'<a href="javascript:void(0);" class="tagDelBtn">x</a></li>');
						tagNmListA[tagListACnt] = tagValue;
						thisElement.val('');
						$('input#tagNmListA').val() == Object.values(tagNmListA).toString();
					} else {
						alert('태그값이 중복됩니다.');
					}
				}
		...
		$('#tagListA').on('click', '.tagDelBtn', function() {
			$(this).parent().remove();
			tagNmListA = {};
			$('#tagListA li').each(function(idx) {
				tagNmListA[(idx+1)] = $(this).html().split('<')[0];
			});
			document.formInsert.tagNmListA.value = Object.values(tagNmListA).toString();
		});
		$('#tagBInput').on('keypress', function (e) {
			var thisElement = $(this);
			if (e.key === 'Enter' || e.keyCode == 32) { // input 에 focus 되있을 때 엔터 및 스페이스바 입력시 구동
				var tagValue = thisElement.val();
				if (tagValue !== "") { // 값이 없으면 동작 안함
					var result = Object.values(tagNmListB).filter(function (word) { // 같은 태그가 있는지 검사한다. 있다면 해당값이 array 로 return 된다.
						return word === tagValue;
					});
					// 태그 중복 검사
					if (result.length == 0) {
						var tagListBCnt = $('#tagListB li').length*1;
						$('#tagListB').append('<li>'+tagValue+'<a href="javascript:void(0);" class="tagDelBtn">x</a></li>');
						tagNmListB[tagListBCnt] = tagValue;
						thisElement.val('');
						$('input#tagNmListB').val() == Object.values(tagNmListB).toString();
					} else {
						alert('태그값이 중복됩니다.');
					}
				}
		...
		$('#tagListB').on('click', '.tagDelBtn', function() {
			$(this).parent().remove();
			tagNmListB = {};
			$('#tagListB li').each(function(idx) {
				tagNmListB[(idx+1)] = $(this).html().split('<')[0];
			});
			document.formInsert.tagNmListB.value = Object.values(tagNmListB).toString();
		});
		$('#tagCInput').on('keypress', function (e) {
			var thisElement = $(this);
			if (e.key === 'Enter' || e.keyCode == 32) { // input 에 focus 되있을 때 엔터 및 스페이스바 입력시 구동
				var tagValue = thisElement.val();
				if (tagValue !== "") { // 값이 없으면 동작 안함
					var result = Object.values(tagNmListC).filter(function (word) { // 같은 태그가 있는지 검사한다. 있다면 해당값이 array 로 return 된다.
						return word === tagValue;
					});
					// 태그 중복 검사
					if (result.length == 0) {
						var tagListCCnt = $('#tagListC li').length*1;
						$('#tagListC').append('<li>'+tagValue+'<a href="javascript:void(0);" class="tagDelBtn">x</a></li>');
						tagNmListC[tagListCCnt] = tagValue;
						thisElement.val('');
						$('input#tagNmListC').val() == Object.values(tagNmListC).toString();
					} else {
						alert('태그값이 중복됩니다.');
					}
				}
		...
		$('#tagListC').on('click', '.tagDelBtn', function() {
			$(this).parent().remove();
			tagNmListC = {};
			$('#tagListC li').each(function(idx) {
				tagNmListC[(idx+1)] = $(this).html().split('<')[0];
			});
			document.formInsert.tagNmListC.value = Object.values(tagNmListC).toString();
		});
	...
	function insertCLN(form) {
		...
		if($('select[name="TEMPL_CD"]').val() === 'A') {
			// seq 1
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[0].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA textarea[name="TMP_LIST[0].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[0].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				}
			}
			// seq 2
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[1].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA textarea[name="TMP_LIST[1].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[1].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[1].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('2번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[1].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 3
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[2].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA textarea[name="TMP_LIST[2].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('3번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[2].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[2].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('3번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[2].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 4
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[3].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA textarea[name="TMP_LIST[3].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('4번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[3].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('4번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 4
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[4].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA textarea[name="TMP_LIST[4].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('5번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[4].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[4].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('5번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[4].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
			//seq 6
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[5].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA textarea[name="TMP_LIST[5].DTIL_LIST[0].TITLE_CT"]').val().length < 1) {
					alert('6-1번째 타이틀이 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[5].DTIL_LIST[0].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertA textarea[name="TMP_LIST[5].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('6-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[5].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[5].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('6-1번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[5].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertA textarea[name="TMP_LIST[5].DTIL_LIST[1].TITLE_CT"]').val().length < 1) {
					alert('6-2번째 타이틀이 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[5].DTIL_LIST[1].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertA textarea[name="TMP_LIST[5].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('6-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[5].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[5].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('6-2번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[5].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 7
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[6].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA textarea[name="TMP_LIST[6].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('7-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[6].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[6].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('7-1번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[6].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[6].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('7-2번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[6].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[6].DTIL_LIST[2].IMG_FILE_NM"]').text().length < 1) {
					alert('7-3번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[6].DTIL_LIST[2].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 8
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[7].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA textarea[name="TMP_LIST[7].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('8번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[7].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[7].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('8번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[7].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 9
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[8].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA textarea[name="TMP_LIST[8].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('9번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[8].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[8].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('9번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[8].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}

			//seq 10
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[9].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[0].TITLE_CT"]').val().length < 1) {
					alert('10-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[0].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('10-1번째 수치가 미입력 되었습니다.');
					$('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[9].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('10-1번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[9].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[1].TITLE_CT"]').val().length < 1) {
					alert('10-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[1].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('10-2번째 수치가 미입력 되었습니다.');
					$('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[9].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('10-2번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[9].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[2].TITLE_CT"]').val().length < 1) {
					alert('10-3번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[2].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[2].TEXT_TX"]').val().length < 1) {
					alert('10-3번째 수치가 미입력 되었습니다.');
					$('#formInsertA input[name="TMP_LIST[9].DTIL_LIST[2].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[9].DTIL_LIST[2].IMG_FILE_NM"]').text().length < 1) {
					alert('10-3번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[9].DTIL_LIST[2].IMG_FILE_NM"]').focus();
					return;
				}
			}
			
			// seq 11
			if(!isValid && $('#formInsertA input:radio[name="TMP_LIST[10].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('11-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('11-1번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('11-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('11-2번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[2].TEXT_TX"]').val().length < 1) {
					alert('11-3번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[2].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[2].IMG_FILE_NM"]').text().length < 1) {
					alert('11-3번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[2].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[3].TEXT_TX"]').val().length < 1) {
					alert('11-4번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[3].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[3].IMG_FILE_NM"]').text().length < 1) {
					alert('11-4번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[3].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[4].TEXT_TX"]').val().length < 1) {
					alert('11-5번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[4].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[4].IMG_FILE_NM"]').text().length < 1) {
					alert('11-5번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[4].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[5].TEXT_TX"]').val().length < 1) {
					alert('11-6번째 텍스트가 미입력 되었습니다.');
					$('#formInsertA textarea[name="TMP_LIST[10].DTIL_LIST[5].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[5].IMG_FILE_NM"]').text().length < 1) {
					alert('11-6번째 파일이 없습니다.');
					$('#formInsertA a[name="TMP_LIST[10].DTIL_LIST[5].IMG_FILE_NM"]').focus();
					return;
				}
			}
		...
		if($('select[name="TEMPL_CD"]').val() === 'B') {
			// seq 1
			if(!isValid && $('#formInsertB input:radio[name="TMP_LIST[0].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertB textarea[name="TMP_LIST[0].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[0].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				}
			}
			// seq 2
			if(!isValid && $('#formInsertB input:radio[name="TMP_LIST[1].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertB input[name="TMP_LIST[1].DTIL_LIST[0].TITLE_CT"]').val().length < 1) {
					alert('2-1번째 타이틀이 미입력 되었습니다.');
					$('#formInsertB input[name="TMP_LIST[1].DTIL_LIST[0].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertB textarea[name="TMP_LIST[1].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('2-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[1].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertB a[name="TMP_LIST[1].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('2-1번째 파일이 없습니다.');
					$('#formInsertB a[name="TMP_LIST[1].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertB input[name="TMP_LIST[1].DTIL_LIST[1].TITLE_CT"]').val().length < 1) {
					alert('2-2번째 타이틀이 미입력 되었습니다.');
					$('#formInsertB input[name="TMP_LIST[1].DTIL_LIST[1].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertB textarea[name="TMP_LIST[1].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('2-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[1].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertB a[name="TMP_LIST[1].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('2-2번째 파일이 없습니다.');
					$('#formInsertB a[name="TMP_LIST[1].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				}
			}
			//seq 3
			if(!isValid && $('#formInsertB input:radio[name="TMP_LIST[2].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertB input[name="TMP_LIST[2].DTIL_LIST[0].TITLE_CT"]').val().length < 1) {
					alert('3-1번째 타이틀이 미입력 되었습니다.');
					$('#formInsertB input[name="TMP_LIST[2].DTIL_LIST[0].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertB textarea[name="TMP_LIST[2].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('3-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[2].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertB a[name="TMP_LIST[2].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('3-1번째 파일이 없습니다.');
					$('#formInsertB a[name="TMP_LIST[2].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertB input[name="TMP_LIST[2].DTIL_LIST[1].TITLE_CT"]').val().length < 1) {
					alert('3-2번째 타이틀이 미입력 되었습니다.');
					$('#formInsertB input[name="TMP_LIST[2].DTIL_LIST[1].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertB textarea[name="TMP_LIST[2].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('3-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[2].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertB a[name="TMP_LIST[2].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('3-2번째 파일이 없습니다.');
					$('#formInsertB a[name="TMP_LIST[2].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 4
			if(!isValid && $('#formInsertB input:radio[name="TMP_LIST[3].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertB textarea[name="TMP_LIST[3].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('4-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[3].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertB a[name="TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('4-1번째 파일이 없습니다.');
					$('#formInsertB a[name="TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 5
			if(!isValid && $('#formInsertB input:radio[name="TMP_LIST[4].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertB textarea[name="TMP_LIST[4].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('5-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[4].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				}
				if($('#formInsertB textarea[name="TMP_LIST[4].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('5-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[4].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				}
			}
			//seq 6
			if(!isValid && $('#formInsertB input:radio[name="TMP_LIST[5].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertB input[name="TMP_LIST[5].DTIL_LIST[0].TITLE_CT"]').val().length < 1) {
					alert('6-1번째 타이틀이 미입력 되었습니다.');
					$('#formInsertB input[name="TMP_LIST[5].DTIL_LIST[0].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertB textarea[name="TMP_LIST[5].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('6-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[5].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertB a[name="TMP_LIST[5].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('6-1번째 파일이 없습니다.');
					$('#formInsertB a[name="TMP_LIST[5].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertB input[name="TMP_LIST[5].DTIL_LIST[1].TITLE_CT"]').val().length < 1) {
					alert('6-2번째 타이틀이 미입력 되었습니다.');
					$('#formInsertB input[name="TMP_LIST[5].DTIL_LIST[1].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertB textarea[name="TMP_LIST[5].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('6-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[5].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertB a[name="TMP_LIST[5].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('6-2번째 파일이 없습니다.');
					$('#formInsertB a[name="TMP_LIST[5].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 7
			if(!isValid && $('#formInsertB input:radio[name="TMP_LIST[6].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertB textarea[name="TMP_LIST[6].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('7-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertB textarea[name="TMP_LIST[6].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertB a[name="TMP_LIST[6].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('7-1번째 파일이 없습니다.');
					$('#formInsertB a[name="TMP_LIST[6].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
		...
		if($('select[name="TEMPL_CD"]').val() === 'C') {
			// seq 1
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[0].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC textarea[name="TMP_LIST[0].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[0].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				}
			}
			// seq 2
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[1].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC textarea[name="TMP_LIST[1].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[1].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[1].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('2번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[1].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 3
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[2].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC textarea[name="TMP_LIST[2].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('3번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[2].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[2].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('3번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[2].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 4
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[3].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC input[name="TMP_LIST[3].DTIL_LIST[0].TITLE_CT"]').val().length < 1) {
					alert('4-1번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC input[name="TMP_LIST[3].DTIL_LIST[0].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[3].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('4-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[3].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('4-1번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[3].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC input[name="TMP_LIST[3].DTIL_LIST[1].TITLE_CT"]').val().length < 1) {
					alert('4-2번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC input[name="TMP_LIST[3].DTIL_LIST[1].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[3].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('4-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[3].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[3].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('4-2번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[3].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 5
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[4].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC textarea[name="TMP_LIST[4].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('5번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[4].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[4].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('5번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[4].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
			// seq 6
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[5].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC textarea[name="TMP_LIST[5].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('6번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[5].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[5].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('6-1번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[5].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[5].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('6-2번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[5].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[5].DTIL_LIST[2].IMG_FILE_NM"]').text().length < 1) {
					alert('6-3번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[5].DTIL_LIST[2].IMG_FILE_NM"]').focus();
					return;
				}
			}
			
			//seq 7
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[6].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[0].TITLE_CT"]').val().length < 1) {
					alert('7-1번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[0].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('7-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[6].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('7-1번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[6].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[1].TITLE_CT"]').val().length < 1) {
					alert('7-2번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[1].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('7-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[6].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('7-2번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[6].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[2].TITLE_CT"]').val().length < 1) {
					alert('7-3번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[2].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[2].TEXT_TX"]').val().length < 1) {
					alert('7-3번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[2].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[6].DTIL_LIST[2].IMG_FILE_NM"]').text().length < 1) {
					alert('7-3번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[6].DTIL_LIST[2].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[3].TITLE_CT"]').val().length < 1) {
					alert('7-4번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[3].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[3].TEXT_TX"]').val().length < 1) {
					alert('7-4번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[6].DTIL_LIST[3].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[6].DTIL_LIST[3].IMG_FILE_NM"]').text().length < 1) {
					alert('7-4번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[6].DTIL_LIST[3].IMG_FILE_NM"]').focus();
					return;
				}
			}
			
			//seq 8
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[7].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[0].TITLE_CT"]').val().length < 1) {
					alert('8-1번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[0].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('8-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[7].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('8-1번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[7].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[1].TITLE_CT"]').val().length < 1) {
					alert('8-2번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[1].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('8-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[7].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('8-2번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[7].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[2].TITLE_CT"]').val().length < 1) {
					alert('8-3번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[2].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[2].TEXT_TX"]').val().length < 1) {
					alert('8-3번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[2].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[7].DTIL_LIST[2].IMG_FILE_NM"]').text().length < 1) {
					alert('8-3번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[7].DTIL_LIST[2].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[3].TITLE_CT"]').val().length < 1) {
					alert('8-4번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[3].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[3].TEXT_TX"]').val().length < 1) {
					alert('8-4번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[7].DTIL_LIST[3].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[7].DTIL_LIST[3].IMG_FILE_NM"]').text().length < 1) {
					alert('8-4번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[7].DTIL_LIST[3].IMG_FILE_NM"]').focus();
					return;
				}
			}
			
			//seq 9
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[8].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[0].TITLE_CT"]').val().length < 1) {
					alert('9-1번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[0].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('9-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[8].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('9-1번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[8].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[1].TITLE_CT"]').val().length < 1) {
					alert('9-2번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[1].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('9-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[8].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('9-2번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[8].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[2].TITLE_CT"]').val().length < 1) {
					alert('9-3번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[2].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[2].TEXT_TX"]').val().length < 1) {
					alert('9-3번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[2].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[8].DTIL_LIST[2].IMG_FILE_NM"]').text().length < 1) {
					alert('9-3번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[8].DTIL_LIST[2].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[3].TITLE_CT"]').val().length < 1) {
					alert('9-4번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[3].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[3].TEXT_TX"]').val().length < 1) {
					alert('9-4번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[3].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[8].DTIL_LIST[3].IMG_FILE_NM"]').text().length < 1) {
					alert('9-4번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[8].DTIL_LIST[3].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[4].TITLE_CT"]').val().length < 1) {
					alert('9-5번째 타이틀이 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[4].TITLE_CT"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[4].TEXT_TX"]').val().length < 1) {
					alert('9-5번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[8].DTIL_LIST[4].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[8].DTIL_LIST[4].IMG_FILE_NM"]').text().length < 1) {
					alert('9-5번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[8].DTIL_LIST[4].IMG_FILE_NM"]').focus();
					return;
				}
			}
			
			// seq 10
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[9].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC textarea[name="TMP_LIST[9].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('10번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[9].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[9].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('10번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[9].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				}
			}
			
			// seq 11
			if(!isValid && $('#formInsertC input:radio[name="TMP_LIST[10].USE_YN"]:checked').val() === 'Y') {
				if($('#formInsertC textarea[name="TMP_LIST[10].DTIL_LIST[0].TEXT_TX"]').val().length < 1) {
					alert('11-1번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[10].DTIL_LIST[0].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[10].DTIL_LIST[0].IMG_FILE_NM"]').text().length < 1) {
					alert('11-1번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[10].DTIL_LIST[0].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[10].DTIL_LIST[1].TEXT_TX"]').val().length < 1) {
					alert('11-2번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[10].DTIL_LIST[1].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[10].DTIL_LIST[1].IMG_FILE_NM"]').text().length < 1) {
					alert('11-2번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[10].DTIL_LIST[1].IMG_FILE_NM"]').focus();
					return;
				}else if($('#formInsertC textarea[name="TMP_LIST[10].DTIL_LIST[2].TEXT_TX"]').val().length < 1) {
					alert('11-3번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[10].DTIL_LIST[2].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[10].DTIL_LIST[2].IMG_FILE_NM"]').text().length < 1) {
					alert('11-3번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[10].DTIL_LIST[2].IMG_FILE_NM"]').focus();
					return;
				} else if($('#formInsertC textarea[name="TMP_LIST[10].DTIL_LIST[3].TEXT_TX"]').val().length < 1) {
					alert('11-4번째 텍스트가 미입력 되었습니다.');
					$('#formInsertC textarea[name="TMP_LIST[10].DTIL_LIST[3].TEXT_TX"]').focus();
					return;
				} else if($('#formInsertC a[name="TMP_LIST[10].DTIL_LIST[3].IMG_FILE_NM"]').text().length < 1) {
					alert('11-4번째 파일이 없습니다.');
					$('#formInsertC a[name="TMP_LIST[10].DTIL_LIST[3].IMG_FILE_NM"]').focus();
					return;
				}
			}
		} // C 끝
		
		if(!isValid && $('#formInsert'+$('select[name="TEMPL_CD"]').val()+' input[name="MAJOR_DISS_CDS"]').val().length < 1) {
			alert('주요 질환을 선택해 주시기 바랍니다.');
			return;
		}
		if(!isValid && $('#formInsert'+$('select[name="TEMPL_CD"]').val()+' input[name="DR_IDS"]').val().length < 1) {
			alert('의료진을 선택해 주시기 바랍니다.');
			return;
		}
		
		$('input[name=TEMPL_CD]').val($("select[name=TEMPL_CD]").val());
		if($('input[name=TEMPL_CD]').val() === 'A'){
			form.SEARCH_TAGS.value = Object.values(tagNmListA).toString();
			
		}
		if($('input[name=TEMPL_CD]').val() === 'B'){
			form.SEARCH_TAGS.value = Object.values(tagNmListB).toString();
		}
		if($('input[name=TEMPL_CD]').val() === 'C'){
			form.SEARCH_TAGS.value = Object.values(tagNmListC).toString();
		}
		form.submit();
	}
	/*********************************************************
