...
<h3 class="mid_tit mg_t50">자주하는 질문 <spring:message code="title.create" /></h3>
...
<form:form commandName="faqVO" name="formInsert" action="/admin/hpm/faq/insertFaq.do" method="post" onSubmit="insertFaq(document.formInsert); return false;" enctype="multipart/form-data">
	<div class="board_ty">
		<table>
			<colgroup>
					...
					<td class="ta_l">
						<div class="input_wrap">
							<select class="select" id="categoryCode" name="categoryCode">
								<option value="FAQ001">진료문의</option>
								<option value="FAQ002">검진문의</option>
								<option value="FAQ003">내시경문의</option>
								<option value="FAQ004">수술문의</option>
								<option value="FAQ005">기타문의</option>
							</select>
						</div>
					</td>
				</tr>
	...
	<div class="btns">
		<a href="#none" onclick="javascript:insertFaq(document.formInsert)" class="btn_ty02">저장하기</a>
	...
	<input type="hidden" name="qestnCn" value="">
</form:form>
