...
<h3 class="mid_tit mg_t50">프로모션 등록</h3>
...
<form:form commandName="articleVO" name="formInsert" action="/admin/hpm/umm/insertPromotion.do" method="post" onSubmit="insertPromotion(document.formInsert); return false;" enctype="multipart/form-data">
	<div class="board_ty">
		<table>
			<colgroup>
	...
	<div class="btns">
		<a href="#none" onclick="javascript:insertPromotion(document.formInsert)" class="btn_ty02">저장하기</a>
