...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/css/fbcms/mobileEng/slick.css"><!-- slider -->
		<link rel="stylesheet" type="text/css" href="/css/fbcms/mobileEng/common.css">
		<link rel="icon" type="image/png"  href="/images/favicon.png"/>
		<script type="text/javascript" src="/js/fbcms/mobileEng/jquery.js"></script>
		<script type="text/javascript" src="/js/fbcms/mobileEng/slick.js"></script><!-- slider -->
		<script type="text/javascript" src="/js/fbcms/mobileEng/common.js"></script>
		<script>
