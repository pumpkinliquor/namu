...
<html lang="ja">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/css/fbcms/mobileJpn/slick.css"><!-- slider -->
		<link rel="stylesheet" type="text/css" href="/css/fbcms/mobileJpn/common.css">
		<link rel="icon" type="image/png"  href="/images/favicon.png"/>
		<script type="text/javascript" src="/js/fbcms/mobileJpn/jquery.js"></script>
		<script type="text/javascript" src="/js/fbcms/mobileJpn/slick.js"></script><!-- slider -->
		<script type="text/javascript" src="/js/fbcms/mobileJpn/common.js"></script>
		<script>
