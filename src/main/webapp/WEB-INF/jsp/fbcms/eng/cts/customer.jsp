...
<div class="contents">
	<div class="w1200">
		...
		<div class="box_blue mt30">
			...
			<h6 class="con_in_tit10">* Reservations: 1577-7502, Fax : 02-519-8855</h6>
			<h6 class="con_in_tit10">* Patients with medical benefits who wish to receive second-stage treatment at the hospital must submit the “request for medical benefit”<br>
			<span style="margin-left:11px"></span>
			issued by the doctor of the first-stage medical benefit institution to the hospital administrative staff within 7 days from the date of issue<br>
			<span style="margin-left:11px"></span>(excluding holidays)</h6>
		</div>
	</div>
	<section class="location_map">
		<div class="w1200">
			<img src="/images/fbcms/eng/img_map.png" alt="">
			<div>
				<h3>Directions</h3>
				<h4>Address</h4>
