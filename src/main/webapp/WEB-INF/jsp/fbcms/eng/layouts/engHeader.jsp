...
<html lang="zh-Hans">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/css/fbcms/eng/slick.css"><!-- slider -->
		<link rel="stylesheet" type="text/css" href="/css/fbcms/eng/common.css">
		<link rel="icon" type="image/png"  href="/images/favicon.png"/>
		<script type="text/javascript" src="/js/fbcms/eng/jquery.js"></script>
		<script type="text/javascript" src="/js/fbcms/eng/slick.js"></script><!-- slider -->
		<script type="text/javascript" src="/js/fbcms/eng/common.js"></script>
		<script>
