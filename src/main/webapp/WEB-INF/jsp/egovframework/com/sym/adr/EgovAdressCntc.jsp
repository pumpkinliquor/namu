...
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				<span class="btn_b"><a href="#none" onclick="getAddrLoc();" title="<spring:message code="symAdr.btn.addrLoc" /> <spring:message code="input.button" />"><spring:message code="symAdr.btn.addrLoc" /></a></span><!-- 주소가져오기(Controller) -->
				<span class="btn_b"><a href="#none" onclick="getAddr();" title="<spring:message code="symAdr.btn.addrjson" /> <spring:message code="input.button" />"><spring:message code="symAdr.btn.addrjson" /></a></span><!-- 주소가져오기(JSON) -->
			</li>
		</ul>
	</div>
