	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg"/>"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="#none" onclick="fn_egov_search_RecentSrchwrd(); return false;" title="<spring:message code="button.inquire" />"><spring:message code="button.inquire" /></a></span>
				<span class="btn_b"><a href="#none" onclick="fn_egov_deleteAll_RecentSrchwrd(); return false;" title="<spring:message code="ussIonRsm.recentSrchwrdResultList.deleteAllButton"/>"><spring:message code="ussIonRsm.recentSrchwrdResultList.deleteAllButton"/></a></span><!-- 전체삭제 -->
			</li>
		</ul>
	</div>
