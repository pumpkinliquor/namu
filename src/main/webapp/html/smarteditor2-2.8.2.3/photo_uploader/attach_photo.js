    ...
    function html5Upload() {	
    	...
    	//sUploadURL= '/utl/wed/insertSEitorImage.do';
    	//sUploadURL= '/html/smarteditor2-2.8.2.3/photo_uploader/file_uploader_html5.jsp';
    	sUploadURL= '/utl/wed/insertSEitorImage5.do';
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/html/smarteditor2-2.8.2.3/photo_uploader/file_uploader.jsp',
 	        sCallback : '/html/smarteditor2-2.8.2.3/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
