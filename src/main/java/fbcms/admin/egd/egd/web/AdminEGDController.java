package fbcms.admin.egd.egd.web;
...
/**
* 안저판독(EyeGroundDecipher)을 처리하는 비즈니스 구현 클래스
*/

@Controller
public class AdminEGDController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AdminEGDController.class);
	...
	/**
	 * 안저판독 게시물에 대한 목록을 조회한다.
	 */
	@RequestMapping("/admin/egd/egd/selectEGDList.do")
	public String selectEGDList(@ModelAttribute("searchVO") AdminBoardVO articleVO, ModelMap model) throws Exception {
		...
		articleVO.setBbsId("BBSMSTR_000000000011");
		...
		return "admin/egd/egd/adminEGDList";
	}
	
	/**
	 * 안저판독 게시물에 대한 목록을 조회한다.
	 */
	@RequestMapping("/admin/egd/egd/selectEGDListExcel.do")
	public String selectEGDListExcel(@ModelAttribute("searchVO") AdminBoardVO boardVO, ModelMap model) throws Exception {
		...
		boardVO.setBbsId("BBSMSTR_000000000011");
	...
	/**
	 * 안저판독 게시물에 대한 상세 정보를 조회한다.
	 */
	@RequestMapping("/admin/egd/egd/selectEGDDetail.do")
	public String selectEGDDetail(@ModelAttribute("searchVO") AdminBoardVO boardVO, ModelMap model) throws Exception {
		...
		return "admin/egd/egd/adminEGDDetail";
	}

	/**
	 * 안저판독 게시물 등록을 위한 등록페이지로 이동한다.
	 */
	@RequestMapping("/admin/egd/egd/insertEGDView.do")
	public String insertEGDView(@ModelAttribute("searchVO") AdminBoardVO boardVO, ModelMap model) throws Exception {
		...
		return "admin/egd/egd/adminEGDRegist";
	}

	/**
	 * 안저판독 게시물을 등록한다.
	 */
	@RequestMapping("/admin/egd/egd/insertEGD.do")
	public String insertEGD(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") AdminBoardVO boardVO,
		@ModelAttribute("bdMstr") AdminBoardMaster bdMstr, @ModelAttribute("board") AdminBoardVO board, BindingResult bindingResult, 
		...
		if (bindingResult.hasErrors()) {
			...
			return "redirect:/admin/egd/egd/insertEGDView.do";
		}
		...
		return "redirect:/admin/egd/egd/selectEGDList.do";
	}

	/**
	 * 안저판독 게시물 수정을 위한 수정페이지로 이동한다.
	 */
	@RequestMapping("/admin/egd/egd/updateEGDView.do")
	public String updateEGDView(@ModelAttribute("searchVO") AdminBoardVO boardVO, @ModelAttribute("board") AdminBoardVO vo, ModelMap model)
		throws Exception {
		...
		return "admin/egd/egd/adminEGDUpdt";
	}

	/**
	 * 안저판독 게시물에 대한 내용을 수정한다.
	 */
	@RequestMapping("/admin/egd/egd/updateEGD.do")
	public String updateEGD(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") AdminBoardVO boardVO,
		@ModelAttribute("bdMstr") AdminBoardMaster bdMstr, @ModelAttribute("board") AdminBoard board, BindingResult bindingResult, 
		ModelMap model, RedirectAttributes redirectAttributes) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			model.addAttribute("resultMsg", bindingResult.getAllErrors().get(0).getDefaultMessage());
			return "redirect:/admin/egd/egd/updateEGDView.do";
		}
	...
	/**
	 * 안저판독 게시물에 대한 내용을 삭제한다.
	 */
	@RequestMapping("/admin/egd/egd/deleteEGD.do")
	public String deleteEGD(HttpServletRequest request, @ModelAttribute("searchVO") AdminBoardVO boardVO, @ModelAttribute("board") AdminBoard board,
		@ModelAttribute("bdMstr") AdminBoardMaster bdMstr, ModelMap model, RedirectAttributes redirectAttributes) throws Exception {
