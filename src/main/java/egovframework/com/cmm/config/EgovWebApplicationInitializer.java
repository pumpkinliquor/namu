...
public class EgovWebApplicationInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		if("security".equals(EgovProperties.getProperty("Globals.Auth").trim())) {
			...
			//로그인 실패시 반활 될 URL설정
			egovSpringSecurityLoginFilter.setInitParameter("loginURL", "/admin/lgn/adminLogin.do");
			//로그인 처리 URL설정
			egovSpringSecurityLoginFilter.setInitParameter("loginProcessURL", "/admin/lgn/actionLogin.do");
			//처리 Url Pattern
			...
			egovSpringSecurityLogoutFilter.addMappingForUrlPatterns(null, false, "/admin/lgn/actionLogout.do");
			...
			egovLoginPolicyFilter.addMappingForUrlPatterns(null, false, "/admin/lgn/actionLogin.do");
