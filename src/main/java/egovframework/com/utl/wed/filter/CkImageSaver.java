...
public class CkImageSaver {
    ...
    private String fileStorePathLocal = EgovProperties.getProperty("Globals.fileStorePathLocal");
    private String fileStorePathDev = EgovProperties.getProperty("Globals.fileStorePathDev");
		...
		try {
			...
			if (isAllowFileType(FilenameUtils.getName(uplFile.getName()))) {
				...
				if(SystemUtils.IS_OS_WINDOWS) {
					uploadFilePath = fileSaveManager.saveFile(uplFile, fileStorePathLocal + imageBaseDir);
				} else {
					uploadFilePath = fileSaveManager.saveFile(uplFile, fileStorePathDev + imageBaseDir);
				}
